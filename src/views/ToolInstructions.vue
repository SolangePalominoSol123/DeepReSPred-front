    ...
    <div class="container">
            ...
            <div class="row" style="margin-bottom: 35px; margin-top: 25px;">
              <div class="col-sm">
                ...
                <label class="labels">After inserting the request ID and press the button, DeepReSPred will show you its status. This can take five values: <label style="font-weight: bold;">No Status</label>, means that has been some error in retrieving the information or perhaps the request does not exists.</label>
                ...
                <label class="labels"><label style="font-weight: bold;">Registered</label> and <label style="font-weight: bold;">Processing</label> status are good signals that your request is being or it will be attended.</label>
                <label class="labels">In the same way, the <label style="font-weight: bold;">Completed</label> status means that the prediction process has finished. In this case you will be able to see a list of the results generated by the algorithm.</label>
              </div>
              <div class="col-sm">
                ...
                <label class="labels">DeepReSPred uses the <label style="font-weight: bold;">Mol*</label> component to get it. This tool has more functionalities availables as viewer in full screen, zoom in, zoom out, a spin option and more.</label>
                <label class="labels">You can also download the generated files. You just have to select the buttons corresponding to the structure you want.</label>
              </div>
              <div class="col-sm">
                <h3 class="statusSingle">9</h3>
                <h3 class="titleBold">Resend the results to your email</h3>
                <label class="labels">Finally but not least, even you have registered or not an email for the prediction request, you could get <label style="font-weight: bold;">all the result files</label> in your email. Just insert a valid email and press the button "Send".</label>
